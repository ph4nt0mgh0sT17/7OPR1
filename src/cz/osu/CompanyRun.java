...
public class CompanyRun {
    public static void main(String[] args) {
        ...
        company.addPayable(new Invoice("Blue pen", 5, new Crowns(50)));
        company.addPayable(new Invoice("Platinum bread", 15, new Crowns(5)));
        company.addPayable(new Invoice("Easy GALPR", 20, new Crowns(250)));
